...
###you have to change path, data_name, fm, col_num!
...
start_fn = function(){
	...
	path = "C:/Users/YISS/Desktop/data_mining/hw/hw2/submitted"
	setwd(path)
}
...
#which column the response variable is recorded
response_var_col()			###you have to change col_num of y!
1

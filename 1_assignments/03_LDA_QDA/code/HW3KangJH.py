...
def save_as_file_reg():
	with open("HW3KangJH_python_regression_output.txt","w") as txt:
		print("Coefficients", "\n", "-------------",sep="", file=txt)
...
def classification():
	global what
	print("Select the classifier(1 = 'LDA' or 2 = 'QDA')")
	what = int(input("Select the classifier(1 = 'LDA' or 2 = 'QDA')"))
	if what == 1:
		classification_LDA()
	elif what == 2:
		classification_QDA()
...
def save_as_file_classification():
	with open("HW3KangJH_python_classification_output.txt","w") as txt:

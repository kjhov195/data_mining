...
print_fn_reg = function(){
	sink('HW6KangJH_R_regression_output.txt')
	cat("Coefficients", "\n", "-------------", "\n",sep="")
...
classification = function(){
	...
	if (num_of_class > 2){
		...
		cat("Select the classifier(1 = 'LDA' or 2 = 'QDA' or 3 = 'RDA' or 4 = 'Logistic' or 5 = 'Naive_bayes')")
		what <<- scan(n=1, quiet=TRUE)
	}
...
print_fn_classification = function(){
	output_file <<- paste("HW6KangJH_R_", name, "_output.txt", sep="")
...
reg_or_cla()
C:/Users/YISS/Desktop/data_mining/hw/hw6
2
heart.dat
1
heart.dat
